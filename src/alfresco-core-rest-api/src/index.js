(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([
      ...
      './model/DeletedNodeMinimal',
      './model/DeletedNodeMinimalEntry',
      ...
      './model/NodeAssocMinimalEntry',
      './model/NodeAssocPaging',
      './model/NodeAssocPagingList',
      './model/NodeBody',
      './model/NodeChildAssocMinimal',
      './model/NodeChildAssocMinimalEntry',
      './model/NodeChildAssocPaging',
      './model/NodeChildAssocPagingList',
      './model/NodeEntry',
      './model/NodeFull',
      './model/NodeMinimal',
      './model/NodeMinimalEntry',
      './model/NodePaging',
      './model/NodePagingList',
      './model/NodeSharedLink',
      './model/NodeSharedLinkEntry',
      './model/NodeSharedLinkPaging',
      './model/NodeSharedLinkPagingList',
      ...
      './model/SiteMemberRoleBody',
      './model/SiteMembershipBody',
    ...
    module.exports = factory(
      ...
      require('./model/ActivityActivitySummary'),
      require('./model/ActivityEntry'),
      require('./model/ActivityPaging'),
      require('./model/ActivityPagingList'),
      require('./model/AssocChildBody'),
      require('./model/AssocInfo'),
      require('./model/AssocTargetBody'),
      require('./model/Candidate'),
      require('./model/CandidateEntry'),
      require('./model/CandidatePaging'),
      require('./model/CandidatePagingList'),
      require('./model/ChildAssocInfo'),
      require('./model/ChildAssociationInfo'),
      require('./model/Comment'),
      require('./model/CommentBody'),
      require('./model/CommentBody1'),
      require('./model/CommentEntry'),
      require('./model/CommentPaging'),
      require('./model/CommentPagingList'),
      require('./model/Company'),
      require('./model/ContentInfo'),
      require('./model/CopyBody'),
      require('./model/DeletedNode'),
      require('./model/DeletedNodeEntry'),
      require('./model/DeletedNodeMinimal'),
      require('./model/DeletedNodeMinimalEntry'),
      require('./model/DeletedNodesPaging'),
      require('./model/DeletedNodesPagingList'),
      require('./model/EmailSharedLinkBody'),
      require('./model/Error'),
      require('./model/ErrorError'),
      require('./model/Favorite'),
      require('./model/FavoriteBody'),
      require('./model/FavoriteEntry'),
      require('./model/FavoritePaging'),
      require('./model/FavoritePagingList'),
      require('./model/FavoriteSiteBody'),
      require('./model/Group'),
      require('./model/GroupEntry'),
      require('./model/GroupPaging'),
      require('./model/GroupPagingList'),
      require('./model/InlineResponse201'),
      require('./model/InlineResponse201Entry'),
      require('./model/Item'),
      require('./model/ItemBody'),
      require('./model/ItemEntry'),
      require('./model/ItemPaging'),
      require('./model/ItemPagingList'),
      require('./model/MoveBody'),
      require('./model/NetworkQuota'),
      require('./model/NodeAssocMinimal'),
      require('./model/NodeAssociationPaging'),
      require('./model/NodeAssociationPagingList'),
      require('./model/NodeBodyLock'),
      require('./model/NodeChildAssociation'),
      require('./model/NodeChildAssociationEntry'),
      require('./model/NodeChildAssociationPaging'),
      require('./model/NodeChildAssociationPagingList'),
      require('./model/Node'),
      require('./model/NodeAssociation'),
      require('./model/NodeAssociationEntry'),
      require('./model/NodeAssocMinimalEntry'),
      require('./model/NodeAssocPaging'),
      require('./model/NodeAssocPagingList'),
      require('./model/NodeBody'),
      require('./model/NodeChildAssocMinimal'),
      require('./model/NodeChildAssocMinimalEntry'),
      require('./model/NodeChildAssocPaging'),
      require('./model/NodeChildAssocPagingList'),
      require('./model/NodeEntry'),
      require('./model/NodeFull'),
      require('./model/NodeMinimal'),
      require('./model/NodeMinimalEntry'),
      require('./model/NodePaging'),
      require('./model/NodePagingList'),
      require('./model/NodeSharedLink'),
      require('./model/NodeSharedLinkEntry'),
      require('./model/NodeSharedLinkPaging'),
      require('./model/NodeSharedLinkPagingList'),
      require('./model/NodesnodeIdchildrenContent'),
      require('./model/Pagination'),
      require('./model/PathElement'),
      require('./model/PathInfo'),
      require('./model/PermissionElement'),
      require('./model/PermissionsInfo'),
      require('./model/PersonPaging'),
      require('./model/PersonPagingList'),
      require('./model/Person'),
      require('./model/PersonEntry'),
      require('./model/PersonNetwork'),
      require('./model/PersonNetworkEntry'),
      require('./model/PersonNetworkPaging'),
      require('./model/PersonNetworkPagingList'),
      require('./model/Preference'),
      require('./model/PreferenceEntry'),
      require('./model/PreferencePaging'),
      require('./model/PreferencePagingList'),
      require('./model/Process'),
      require('./model/ProcessBody'),
      require('./model/ProcessBodyVariable'),
      require('./model/ProcessEntry'),
      require('./model/ProcessPaging'),
      require('./model/ProcessPagingList'),
      require('./model/ProcessDefinition'),
      require('./model/ProcessDefinitionEntry'),
      require('./model/ProcessDefinitionPaging'),
      require('./model/ProcessDefinitionPagingList'),
      require('./model/Rating'),
      require('./model/RatingAggregate'),
      require('./model/RatingBody'),
      require('./model/RatingEntry'),
      require('./model/RatingPaging'),
      require('./model/RatingPagingList'),
      require('./model/Rendition'),
      require('./model/RenditionBody'),
      require('./model/RenditionEntry'),
      require('./model/RenditionPaging'),
      require('./model/RenditionPagingList'),
      require('./model/SharedLinkBody'),
      require('./model/Site'),
      require('./model/SiteBody'),
      require('./model/SiteContainer'),
      require('./model/SiteContainerEntry'),
      require('./model/SiteContainerPaging'),
      require('./model/SiteEntry'),
      require('./model/SiteMember'),
      require('./model/SiteMemberBody'),
      require('./model/SiteMemberEntry'),
      require('./model/SiteMemberPaging'),
      require('./model/SiteMemberRoleBody'),
      require('./model/SiteMembershipBody'),
      require('./model/SiteMembershipBody1'),
      require('./model/SiteMembershipRequest'),
      require('./model/SiteMembershipRequestEntry'),
      require('./model/SiteMembershipRequestPaging'),
      require('./model/SiteMembershipRequestPagingList'),
      require('./model/SitePaging'),
      require('./model/SitePagingList'),
      require('./model/Tag'),
      require('./model/TagBody'),
      require('./model/TagBody1'),
      require('./model/TagEntry'),
      require('./model/TagPaging'),
      require('./model/TagPagingList'),
      require('./model/Task'),
      require('./model/TaskBody'),
      require('./model/TaskEntry'),
      require('./model/TaskPaging'),
      require('./model/TaskPagingList'),
      require('./model/TaskFormModel'),
      require('./model/TaskFormModelEntry'),
      require('./model/TaskFormModelPaging'),
      require('./model/TaskFormModelPagingList'),
      require('./model/Variable'),
      require('./model/VariableBody'),
      require('./model/VariableEntry'),
      require('./model/VariablePaging'),
      require('./model/VariablePagingList'),
      require('./model/UserInfo'),
      require('./model/AssociationInfo'),
      require('./api/AssociationsApi'),
      require('./api/ChangesApi'),
      require('./api/ChildAssociationsApi'),
      require('./api/CommentsApi'),
      require('./api/FavoritesApi'),
      require('./api/GroupApi'),
      require('./api/NetworksApi'),
      require('./api/NodesApi'),
      require('./api/PeopleApi'),
      require('./api/ProcessesApi'),
      require('./api/ProcessDefinitionsApi'),
      require('./api/RatingsApi'),
      require('./api/RenditionsApi'),
      require('./api/QueriesApi'),
      require('./api/SharedlinksApi'),
      require('./api/SitesApi'),
      require('./api/TagsApi'),
      require('./api/TasksApi'),
      require('./api/WebscriptApi'),
      require('./api/DownloadsApi')
    );
  }
}(function (ApiClient,
            Activity,
  ...
  var exports = {
    ...
    Group: Group,
    /**
     * The GroupEntry model constructor.
     * @property {module:model/GroupEntry}
     */
    GroupEntry: GroupEntry,
    /**
     * The GroupPaging model constructor.
     * @property {module:model/GroupPaging}
     */
    GroupPaging: GroupPaging,
    /**
     * The GroupPagingList model constructor.
     * @property {module:model/GroupPagingList}
     */
    GroupPagingList: GroupPagingList,
    /**
