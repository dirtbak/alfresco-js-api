(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['./ApiClient', './model/Activity', './model/ActivityActivitySummary', './model/ActivityEntry', './model/ActivityPaging', './model/ActivityPagingList', './model/AssocChildBody', './model/AssocInfo', './model/AssocTargetBody', './model/Candidate', './model/CandidateEntry', './model/CandidatePaging', './model/CandidatePagingList', './model/ChildAssocInfo', './model/ChildAssociationInfo', './model/Comment', './model/CommentBody', './model/CommentBody1', './model/CommentEntry', './model/CommentPaging', './model/CommentPagingList', './model/Company', './model/ContentInfo', './model/CopyBody', './model/DeletedNode', './model/DeletedNodeEntry', './model/DeletedNodeMinimal', './model/DeletedNodeMinimalEntry', './model/DeletedNodesPaging', './model/DeletedNodesPagingList', './model/EmailSharedLinkBody', './model/Error', './model/ErrorError', './model/Favorite', './model/FavoriteBody', './model/FavoriteEntry', './model/FavoritePaging', './model/FavoritePagingList', './model/FavoriteSiteBody', './model/InlineResponse201', './model/InlineResponse201Entry', './model/Item', './model/ItemBody', './model/ItemEntry', './model/ItemPaging', './model/ItemPagingList', './model/MoveBody', './model/NetworkQuota', './model/NodeAssocMinimal', './model/NodeAssociationPaging', './model/NodeAssociationPagingList', './model/NodeBodyLock', './model/NodeChildAssociation', './model/NodeChildAssociationEntry', './model/NodeChildAssociationPaging', './model/NodeChildAssociationPagingList', './model/Node', './model/NodeAssociation', './model/NodeAssociationEntry', './model/NodeAssocMinimalEntry', './model/NodeAssocPaging', './model/NodeAssocPagingList', './model/NodeBody', './model/NodeChildAssocMinimal', './model/NodeChildAssocMinimalEntry', './model/NodeChildAssocPaging', './model/NodeChildAssocPagingList', './model/NodeEntry', './model/NodeFull', './model/NodeMinimal', './model/NodeMinimalEntry', './model/NodePaging', './model/NodePagingList', './model/NodeSharedLink', './model/NodeSharedLinkEntry', './model/NodeSharedLinkPaging', './model/NodeSharedLinkPagingList', './model/NodesnodeIdchildrenContent', './model/Pagination', './model/PathElement', './model/PathInfo', './model/PermissionElement', './model/PermissionsInfo', './model/PersonPaging', './model/PersonPagingList', './model/Person', './model/PersonEntry', './model/PersonNetwork', './model/PersonNetworkEntry', './model/PersonNetworkPaging', './model/PersonNetworkPagingList', './model/Preference', './model/PreferenceEntry', './model/PreferencePaging', './model/PreferencePagingList', './model/Process', './model/ProcessBody', './model/ProcessBodyVariable', './model/ProcessEntry', './model/ProcessPaging', './model/ProcessPagingList', './model/ProcessDefinition', './model/ProcessDefinitionEntry', './model/ProcessDefinitionPaging', './model/ProcessDefinitionPagingList', './model/Rating', './model/RatingAggregate', './model/RatingBody', './model/RatingEntry', './model/RatingPaging', './model/RatingPagingList', './model/Rendition', './model/RenditionBody', './model/RenditionEntry', './model/RenditionPaging', './model/RenditionPagingList', './model/SharedLinkBody', './model/Site', './model/SiteBody', './model/SiteContainer', './model/SiteContainerEntry', './model/SiteContainerPaging', './model/SiteEntry', './model/SiteMember', './model/SiteMemberBody', './model/SiteMemberEntry', './model/SiteMemberPaging', './model/SiteMemberRoleBody', './model/SiteMembershipBody', './model/SiteMembershipBody1', './model/SiteMembershipRequest', './model/SiteMembershipRequestEntry', './model/SiteMembershipRequestPaging', './model/SiteMembershipRequestPagingList', './model/SitePaging', './model/SitePagingList', './model/Tag', './model/TagBody', './model/TagBody1', './model/TagEntry', './model/TagPaging', './model/TagPagingList', './model/Task', './model/TaskBody', './model/TaskEntry', './model/TaskPaging', './model/TaskPagingList', './model/TaskFormModel', './model/TaskFormModelEntry', './model/TaskFormModelPaging', './model/TaskFormModelPagingList', './model/UserInfo', './model/Variable', './model/VariableBody', './model/VariableEntry', './model/VariablePaging', './model/VariablePagingList', './model/AssociationInfo', './api/AssociationsApi', './api/ChangesApi', './api/ChildAssociationsApi', './api/CommentsApi', './api/FavoritesApi', './api/NetworksApi', './api/NodesApi', './api/PeopleApi', './api/ProcessesApi', './api/ProcessDefinitionsApi', './api/RatingsApi', './api/RenditionsApi', './api/QueriesApi', './api/SharedlinksApi', './api/SitesApi', './api/TagsApi', './api/TasksApi', './api/WebscriptApi', './api/DownloadsApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Activity'), require('./model/ActivityActivitySummary'), require('./model/ActivityEntry'), require('./model/ActivityPaging'), require('./model/ActivityPagingList'), require('./model/AssocChildBody'), require('./model/AssocInfo'), require('./model/AssocTargetBody'), require('./model/Candidate'), require('./model/CandidateEntry'), require('./model/CandidatePaging'), require('./model/CandidatePagingList'), require('./model/ChildAssocInfo'), require('./model/ChildAssociationInfo'), require('./model/Comment'), require('./model/CommentBody'), require('./model/CommentBody1'), require('./model/CommentEntry'), require('./model/CommentPaging'), require('./model/CommentPagingList'), require('./model/Company'), require('./model/ContentInfo'), require('./model/CopyBody'), require('./model/DeletedNode'), require('./model/DeletedNodeEntry'), require('./model/DeletedNodeMinimal'), require('./model/DeletedNodeMinimalEntry'), require('./model/DeletedNodesPaging'), require('./model/DeletedNodesPagingList'), require('./model/EmailSharedLinkBody'), require('./model/Error'), require('./model/ErrorError'), require('./model/Favorite'), require('./model/FavoriteBody'), require('./model/FavoriteEntry'), require('./model/FavoritePaging'), require('./model/FavoritePagingList'), require('./model/FavoriteSiteBody'), require('./model/InlineResponse201'), require('./model/InlineResponse201Entry'), require('./model/Item'), require('./model/ItemBody'), require('./model/ItemEntry'), require('./model/ItemPaging'), require('./model/ItemPagingList'), require('./model/MoveBody'), require('./model/NetworkQuota'), require('./model/NodeAssocMinimal'), require('./model/NodeAssociationPaging'), require('./model/NodeAssociationPagingList'), require('./model/NodeBodyLock'), require('./model/NodeChildAssociation'), require('./model/NodeChildAssociationEntry'), require('./model/NodeChildAssociationPaging'), require('./model/NodeChildAssociationPagingList'), require('./model/Node'), require('./model/NodeAssociation'), require('./model/NodeAssociationEntry'), require('./model/NodeAssocMinimalEntry'), require('./model/NodeAssocPaging'), require('./model/NodeAssocPagingList'), require('./model/NodeBody'), require('./model/NodeChildAssocMinimal'), require('./model/NodeChildAssocMinimalEntry'), require('./model/NodeChildAssocPaging'), require('./model/NodeChildAssocPagingList'), require('./model/NodeEntry'), require('./model/NodeFull'), require('./model/NodeMinimal'), require('./model/NodeMinimalEntry'), require('./model/NodePaging'), require('./model/NodePagingList'), require('./model/NodeSharedLink'), require('./model/NodeSharedLinkEntry'), require('./model/NodeSharedLinkPaging'), require('./model/NodeSharedLinkPagingList'), require('./model/NodesnodeIdchildrenContent'), require('./model/Pagination'), require('./model/PathElement'), require('./model/PathInfo'), require('./model/PermissionElement'), require('./model/PermissionsInfo'), require('./model/PersonPaging'), require('./model/PersonPagingList'), require('./model/Person'), require('./model/PersonEntry'), require('./model/PersonNetwork'), require('./model/PersonNetworkEntry'), require('./model/PersonNetworkPaging'), require('./model/PersonNetworkPagingList'), require('./model/Preference'), require('./model/PreferenceEntry'), require('./model/PreferencePaging'), require('./model/PreferencePagingList'), require('./model/Process'), require('./model/ProcessBody'), require('./model/ProcessBodyVariable'), require('./model/ProcessEntry'), require('./model/ProcessPaging'), require('./model/ProcessPagingList'), require('./model/ProcessDefinition'), require('./model/ProcessDefinitionEntry'), require('./model/ProcessDefinitionPaging'), require('./model/ProcessDefinitionPagingList'), require('./model/Rating'), require('./model/RatingAggregate'), require('./model/RatingBody'), require('./model/RatingEntry'), require('./model/RatingPaging'), require('./model/RatingPagingList'), require('./model/Rendition'), require('./model/RenditionBody'), require('./model/RenditionEntry'), require('./model/RenditionPaging'), require('./model/RenditionPagingList'), require('./model/SharedLinkBody'), require('./model/Site'), require('./model/SiteBody'), require('./model/SiteContainer'), require('./model/SiteContainerEntry'), require('./model/SiteContainerPaging'), require('./model/SiteEntry'), require('./model/SiteMember'), require('./model/SiteMemberBody'), require('./model/SiteMemberEntry'), require('./model/SiteMemberPaging'), require('./model/SiteMemberRoleBody'), require('./model/SiteMembershipBody'), require('./model/SiteMembershipBody1'), require('./model/SiteMembershipRequest'), require('./model/SiteMembershipRequestEntry'), require('./model/SiteMembershipRequestPaging'), require('./model/SiteMembershipRequestPagingList'), require('./model/SitePaging'), require('./model/SitePagingList'), require('./model/Tag'), require('./model/TagBody'), require('./model/TagBody1'), require('./model/TagEntry'), require('./model/TagPaging'), require('./model/TagPagingList'), require('./model/Task'), require('./model/TaskBody'), require('./model/TaskEntry'), require('./model/TaskPaging'), require('./model/TaskPagingList'), require('./model/TaskFormModel'), require('./model/TaskFormModelEntry'), require('./model/TaskFormModelPaging'), require('./model/TaskFormModelPagingList'), require('./model/Variable'), require('./model/VariableBody'), require('./model/VariableEntry'), require('./model/VariablePaging'), require('./model/VariablePagingList'), require('./model/UserInfo'), require('./model/AssociationInfo'), require('./api/AssociationsApi'), require('./api/ChangesApi'), require('./api/ChildAssociationsApi'), require('./api/CommentsApi'), require('./api/FavoritesApi'), require('./api/NetworksApi'), require('./api/NodesApi'), require('./api/PeopleApi'), require('./api/ProcessesApi'), require('./api/ProcessDefinitionsApi'), require('./api/RatingsApi'), require('./api/RenditionsApi'), require('./api/QueriesApi'), require('./api/SharedlinksApi'), require('./api/SitesApi'), require('./api/TagsApi'), require('./api/TasksApi'), require('./api/WebscriptApi'), require('./api/DownloadsApi'));
  }
}(function (ApiClient, Activity, ActivityActivitySummary, ActivityEntry, ActivityPaging, ActivityPagingList, AssocChildBody, AssocInfo, AssocTargetBody, Candidate, CandidateEntry, CandidatePaging, CandidatePagingList, ChildAssocInfo, ChildAssociationInfo, Comment, CommentBody, CommentBody1, CommentEntry, CommentPaging, CommentPagingList, Company, ContentInfo, CopyBody, DeletedNode, DeletedNodeEntry, DeletedNodeMinimal, DeletedNodeMinimalEntry, DeletedNodesPaging, DeletedNodesPagingList, EmailSharedLinkBody, Error, ErrorError, Favorite, FavoriteBody, FavoriteEntry, FavoritePaging, FavoritePagingList, FavoriteSiteBody, InlineResponse201, InlineResponse201Entry, Item, ItemBody, ItemEntry, ItemPaging, ItemPagingList, MoveBody, NetworkQuota, NodeAssocMinimal, NodeAssociationPaging, NodeAssociationPagingList, NodeBodyLock, NodeChildAssociation, NodeChildAssociationEntry, NodeChildAssociationPaging, NodeChildAssociationPagingList, Node, NodeAssociation, NodeAssociationEntry, NodeAssocMinimalEntry, NodeAssocPaging, NodeAssocPagingList, NodeBody, NodeChildAssocMinimal, NodeChildAssocMinimalEntry, NodeChildAssocPaging, NodeChildAssocPagingList, NodeEntry, NodeFull, NodeMinimal, NodeMinimalEntry, NodePaging, NodePagingList, NodeSharedLink, NodeSharedLinkEntry, NodeSharedLinkPaging, NodeSharedLinkPagingList, NodesnodeIdchildrenContent, Pagination, PathElement, PathInfo, PermissionElement, PermissionsInfo, PersonPaging, PersonPagingList, Person, PersonEntry, PersonNetwork, PersonNetworkEntry, PersonNetworkPaging, PersonNetworkPagingList, Preference, PreferenceEntry, PreferencePaging, PreferencePagingList, Process, ProcessBody, ProcessBodyVariable, ProcessEntry, ProcessPaging, ProcessPagingList, ProcessDefinition, ProcessDefinitionEntry, ProcessDefinitionPaging, ProcessDefinitionPagingList, Rating, RatingAggregate, RatingBody, RatingEntry, RatingPaging, RatingPagingList, Rendition, RenditionBody, RenditionEntry, RenditionPaging, RenditionPagingList, SharedLinkBody, Site, SiteBody, SiteContainer, SiteContainerEntry, SiteContainerPaging, SiteEntry, SiteMember, SiteMemberBody, SiteMemberEntry, SiteMemberPaging, SiteMemberRoleBody, SiteMembershipBody, SiteMembershipBody1, SiteMembershipRequest, SiteMembershipRequestEntry, SiteMembershipRequestPaging, SiteMembershipRequestPagingList, SitePaging, SitePagingList, Tag, TagBody, TagBody1, TagEntry, TagPaging, TagPagingList, Task, TaskBody, TaskEntry, TaskPaging, TaskPagingList, TaskFormModel, TaskFormModelEntry, TaskFormModelPaging, TaskFormModelPagingList, UserInfo, Variable, VariableBody, VariableEntry, VariablePaging, VariablePagingList, AssociationInfo, AssociationsApi, ChangesApi, ChildAssociationsApi, CommentsApi, FavoritesApi, NetworksApi, NodesApi, PeopleApi, ProcessesApi, ProcessDefinitionsApi, RatingsApi, RenditionsApi, QueriesApi, SharedlinksApi, SitesApi, TagsApi, TasksApi, WebscriptApi, DownloadsApi) {
  'use strict';
  ...
  var exports = {
    ...
    Candidate: Candidate,
    /**
     * The CandidateEntry model constructor.
     * @property {module:model/CandidateEntry}
     */
    ...
    Item: Item,
    /**
     * The ItemBody model constructor.
     * @property {module:model/ItemBody}
     */
    ItemBody: ItemBody,
    /**
     * The ItemEntry model constructor.
     * @property {module:model/ItemEntry}
     */
    ItemEntry: ItemEntry,
    /**
     * The ItemPaging model constructor.
     * @property {module:model/ItemPaging}
     */
    ItemPaging: ItemPaging,
    /**
     * The ItemPagingList model constructor.
     * @property {module:model/ItemPagingList}
     */
    ...
    /**
     * The ProcessBodyVariable model constructor.
     * @property {module:model/ProcessBodyVariable}
     */
    ...
    /**
     * The TaskFormModel model constructor.
     * @property {module:model/TaskFormModel}
     */
    TaskFormModel: TaskFormModel,
    /**
     * The TaskFormModelEntry model constructor.
     * @property {module:model/TaskFormModelEntry}
     */
    TaskFormModelEntry: TaskFormModelEntry,
    /**
     * The TaskFormModelPaging model constructor.
     * @property {module:model/TaskFormModelPaging}
     */
    TaskFormModelPaging: TaskFormModelPaging,
    /**
     * The TaskFormModelPagingList model constructor.
     * @property {module:model/TaskFormModelPagingList}
     */
